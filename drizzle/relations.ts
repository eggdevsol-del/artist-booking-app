...
import { users, appointments, conversations, artistSettings, clientContent, clientNotes, consultations, messages, notificationSettings, notificationTemplates, policies, pushSubscriptions, quickActionButtons, socialMessageSync } from "./schema";
...
export const quickActionButtonsRelations = relations(quickActionButtons, ({one}) => ({
	user: one(users, {
...
export const socialMessageSyncRelations = relations(socialMessageSync, ({one}) => ({
	user: one(users, {
