...
(async () => {
  const artistToken = await createSessionToken('test_artist_001', 'P Mason Tattoo Artist');
  const clientToken = await createSessionToken('test_client_001', 'Test Client');
