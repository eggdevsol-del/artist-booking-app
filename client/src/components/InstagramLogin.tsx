...
export default function InstagramLogin({ open, onOpenChange }: InstagramLoginProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogTitle className="text-center text-2xl">Connect with Instagram</DialogTitle>
