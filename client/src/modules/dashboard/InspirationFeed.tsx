            ...
            <div className="mb-24">
                ...
                <Card className="bg-muted/50 border-dashed border-2">
                    <CardContent className="p-6 text-center">
                        <p className="text-muted-foreground mb-4">Start exploring to find your next style</p>
                        <Link href="/explore">
    ...
    return (
        <div className="mb-24">
            ...
            <div className="grid grid-cols-2 gap-3">
                {likes.map((like) => (
                    <div key={like.id} className="aspect-square rounded-xl overflow-hidden relative group">
                        <img
