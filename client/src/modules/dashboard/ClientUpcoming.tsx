            ...
            <Card className="border-none bg-gradient-to-r from-primary/10 to-accent/10 overflow-hidden relative">
                ...
                <CardContent className="p-5 relative z-10">
                    <div className="flex gap-4 items-center mb-4">
                        ...
                        <div>
                            <p className="text-sm text-muted-foreground uppercase tracking-wide font-medium">With</p>
                            <h3 className="font-bold text-xl leading-none">{artist?.name}</h3>
                            <p className="text-sm text-primary mt-1 font-medium">{appointment.title}</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 mb-4">
                        <div className="bg-background/50 rounded-lg p-2 flex items-center gap-2">
                            ...
                            <span className="text-sm font-semibold">{format(startTime, "MMM d")}</span>
                        </div>
                        <div className="bg-background/50 rounded-lg p-2 flex items-center gap-2">
                            <Clock className="w-4 h-4 text-primary" />
                            <span className="text-sm font-semibold">{format(startTime, "h:mm a")}</span>
                        </div>
                    </div>
