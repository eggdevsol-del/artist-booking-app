        ...
        <div className="mb-8">
            ...
            <div className="grid grid-cols-4 gap-2">
                <Link to="/calendar?action=new-booking">
                    <Button variant="outline" className="flex-col h-auto py-3 px-1 gap-2 border-dashed border-primary/30 hover:border-primary w-full">
                ...
                <Link to="/calendar?action=block-time">
                    <Button variant="outline" className="flex-col h-auto py-3 px-1 gap-2 border-dashed border-border hover:border-primary/50 w-full">
